...
var Login = function () {
	...
	var handleForgetPassword = function handleForgetPassword() {
	...
	var handleRegister = function handleRegister() {
		...
		function format(state) {
			...
			var $state = $('<span><img src="/assets/admin/global/img/flags/' + state.element.value.toLowerCase() + '.png" class="img-flag" /> ' + state.text + '</span>');
	...
	return {
		...
		init: function init() {
			...
			$.backstretch(["/assets/admin/pages/media/bg/1.jpg", "/assets/admin/pages/media/bg/2.jpg", "/assets/admin/pages/media/bg/3.jpg", "/assets/admin/pages/media/bg/4.jpg"], {
				fade: 1000,
				duration: 8000
			});
		}

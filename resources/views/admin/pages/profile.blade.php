                            ...
                            <div class="portlet-body">
                                ...
                                <div class="table-scrollable table-scrollable-borderless">
                                    <table class="table table-hover table-light">
                                        ...
                                        <tr>
                                            <td class="fit">
                                                <img class="user-pic" src="/assets/admin/pages/media/users/avatar4.jpg"> </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="fit">
                                                <img class="user-pic" src="/assets/admin/pages/media/users/avatar5.jpg"> </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="fit">
                                                <img class="user-pic" src="/assets/admin/pages/media/users/avatar6.jpg"> </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="fit">
                                                <img class="user-pic" src="/assets/admin/pages/media/users/avatar7.jpg"> </td>
                                            <td>
...
@section('js')
   <script src="/js/admin/pages/profile.min.js" type="text/javascript"></script>
@endsection